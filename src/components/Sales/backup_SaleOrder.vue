<template>
  <v-card class="pa-4" outlined>
    ...
    <v-row>
      ...
      <v-col cols="12" md="10">
        <v-textarea id="txtdeliveryaddress"
    ...
    <v-row>
      <v-col cols="12" md="2">
        ...
        style="width:120px;" class="btn btn-info">
                                    <i class="fas fa-search-plus" aria-hidden="true">&nbsp;เลือกสินค้าเดี่ยว</i>
                                </button>
    ...
    <v-row>
       <v-col cols="12" md="4" xl="2">
          <v-btn color="success" style="width:140px;" @click="confirmSaveData">
...
onMounted(async () => {
    ...
    await saleOrderStore.fetchSaleOrderRunning();
...
const handleSaveData = async () => {
  ...
  await saleOrderStore.saveOrder();
